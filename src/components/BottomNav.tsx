...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-1/2 -translate-x-1/2 z-50 w-full max-w-[480px] h-16 bg-white dark:bg-surface border-t border-gray-200 safe-area-bottom pb-env px-2">
